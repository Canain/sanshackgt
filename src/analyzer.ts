...
export default class Analyzer {
	...
	constructor() {
		...
		this.out = [["Vegetables","0.166667"],["Grains","0.166667"],["Bakery","0.083333"],["Fish","0.083333"],["Fruits","0.083333"],["Fats/Oils","0.083333"],["Meats","0"],["Poultry","0"],["Eggs","0"],["Dairy","0"],["Sugars/sweets","0"],["Cereal","-0.01888833"]];
	...
	fimp(items: Item[], done: AsyncResultCallback<string>) {
		...
		(<any>request).default(options, (error, response, body) => {
			...
			done(error, JSON.stringify(result));
		});
	}
